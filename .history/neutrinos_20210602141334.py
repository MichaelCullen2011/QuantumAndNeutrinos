...
class Oscillations:
    ...
    def calculate(self):
        ...
        for x in self.x_range:
            ...
            for change in self.prob_list.keys():
                if change not in ['ee', 'uu', 'tt']:
                    ...
                    self.prob_list['ee'].append(1 - (self.prob_list['eu'] + self.prob_list['et']))
                    self.prob_list['uu'].append(1 - (self.prob_list['ue'] + self.prob_list['ut']))
                    self.prob_list['tt'].append(1 - (self.prob_list['te'] + self.prob_list['tu']))
        ...
        prob_neut = [self.prob_reduced['e'].values(), self.prob_reduced['u'].values(), self.prob_reduced['t'].values()]
