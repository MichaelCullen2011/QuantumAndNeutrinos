...
class Oscillations:
    ...
    def calculate(self):
        ...
        self.prob_list['ee'] = 1 - (self.prob_list['eu'] + self.prob_list['et'])
        self.prob_list['uu'] = 1 - (self.prob_list['ue'] + self.prob_list['ut'])
        self.prob_list['tt'] = 1 - (self.prob_list['te'] + self.prob_list['tu'])

        prob_e = [self.prob_list['ee'], self.prob_list['eu'], self.prob_list['et']]
        prob_mu = [self.prob_list['uu'], self.prob_list['ue'], self.prob_list['ut']]
        prob_tau = [self.prob_list['tt'], self.prob_list['te'], self.prob_list['tu']]
