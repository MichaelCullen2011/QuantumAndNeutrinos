...
class WaveFunctions:
    def __init__(self, accuracy):
        ...
        prob_at_detector, detector_1, detector_2 = {flavour: [] for flavour in self.flavour_list}, {flavour: [] for flavour in self.flavour_list}, {flavour: [] for flavour in self.flavour_list}
