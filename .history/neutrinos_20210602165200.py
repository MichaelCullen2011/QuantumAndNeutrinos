...
class WaveFunctions:
    def __init__(self, accuracy):
        ...
        self.phi = np.linspace(0, np.pi, accuracy)
    ...
    def prob(self, flavour):
        ...
        if flavour == 'ee':
            ...
            prob_f1 = 1 - (np.sqrt(sin_q_theta['et']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
            prob_f2 = (np.sqrt(sin_q_theta['et']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
        elif flavour == 'et':
            prob_f1 = 1 - (np.sqrt(sin_q_theta['et']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
            prob_f2 = (np.sqrt(sin_q_theta['et']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
        if flavour == 'uu':
            ...
            prob_f1 = 1 - (np.sqrt(sin_q_theta['eu']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
            prob_f2 = (np.sqrt(sin_q_theta['eu']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
        elif flavour == 'ut':
            prob_f1 = 1 - (np.sqrt(sin_q_theta['ut']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
            prob_f2 = (np.sqrt(sin_q_theta['ut']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
        if flavour == 'tt':
            prob_f1 = 1
            prob_f2 = 0
        elif flavour == 'te':
            prob_f1 = 1 - (np.sqrt(sin_q_theta['te']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
            prob_f2 = (np.sqrt(sin_q_theta['te']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
        elif flavour == 'tu':
            prob_f1 = 1 - (np.sqrt(sin_q_theta['tu']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
            prob_f2 = (np.sqrt(sin_q_theta['tu']) / 2) * (1 - order_tau_d_change * np.cos(self.phi))
