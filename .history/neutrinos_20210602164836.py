...
class WaveFunctions:
    def __init__(self, accuracy):
        ...
        flavour_list = ['ee', 'eu', 'e_tau', 'uu', 'ue', 'ut', 'tt', 'te', 'tu']
        prob_at_detector, detector_1, detector_2 = {flavour: [] for flavour in flavour_list}, {flavour: [] for flavour in flavour_list}, {flavour: [] for flavour in flavour_list}
